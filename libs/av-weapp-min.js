  ...
  return function(e) {
    ...
    (function() {
      ...
      O.flatten = function(e, t) {
        ...
        for (var t = e && O.max(e, N).length || 0, n = Array(t), r = 0; r < t; r++) n[r] = O.pluck(e, r);
        return n
    ...
    var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
      ...
      f = function(e) {
        var t = e.method,
          ...
          p = e.onprogress,
          _ = h++;
        u("request(" + _ + ")", t, n, r, o, d);
        var v = {};
        if (r)
          for (var y in r) "object" === i(r[y]) ? v[y] = JSON.stringify(r[y]) : v[y] = r[y];
        return new l(function(e, i) {
          var l = s(t, n).set(d).query(v).send(o);
          p && l.on("progress", p), l.end(function(s, l) {
    ...
    function a(e) {
      for (var t, n, r, i, o = e.split(/\r?\n/), s = {}, a = 0, u = o.length; a < u; ++a) n = o[a], -1 !== (t = n.indexOf(":")) && (r = n.slice(0, t).toLowerCase(), i = g(n.slice(t + 1)), s[r] = i);
      return s
    }
    ...
    var u = function() {
      ...
      y = function(e) {
        function t() {
          ...
          return e.readyState = f, e._headers = {}, e.upload = new v, e
        }
        return s(t, e), u(t, [{
          key: "abort",
          value: function() {
    ...
    */
    ...
    i.init = function(e) {
      ...
      i._setServerURLs(c({}, r(t, u), i._config.serverURLs, h), v), _ ? i._config.realtime = _ : i._sharedConfig.liveQueryRealtime && (i._config.realtime = new i._sharedConfig.liveQueryRealtime({
        appId: t,
        region: u
      }))
      ...
      e.Object = function(t, n) {
          ...
          delete this.attributes[t], this._serverData[t] && (this.attributes[t] = this._serverData[t]), e._arrayEach(this._opSetQueue, function(r) {
            ...
            if (o) {
              var s = p(n.attributes, t),
                ...
                c = a[1],
                l = a[2];
              d(n.attributes, t, o._estimate(u, n, t)), c && c[l] === e.Op._UNSET ? delete c[l] : n._resetCacheForKey(t)
            }
          })
        },
        ...
        set: function(t, n, r) {
          ...
          if (o.isObject(t) || l(t) ? (i = o.mapObject(t, function(t, n) {
            ...
            }), r = n) : (i = {}, v(t), i[t] = e._decode(n, t)), r = r || {}, !i) return this;
        ...
        fetch: function(e, t) {
          var n = this;
          return u("classes", this.className, this.id, "GET", f(e), t).then(function(e) {
            return n._finishFetch(n.parse(e), !0), n
          })
        },
        save: function(t, n, r) {
          var i, s, a;
          o.isObject(t) || l(t) ? (i = t, a = n) : (i = {}, i[t] = n, a = r), a = o.clone(a) || {}, a.wait && (s = o.clone(this.attributes));
          var c = o.clone(a) || {};
          c.wait && (c.silent = !0), i && this.set(i, c);
          var h = this,
            f = [],
            d = [];
          return e.Object._findUnsavedChildren(h, f, d), f.length + d.length > 1 ? e.Object._deepSaveAsync(this, h, a) : (this._startSave(), this._saving = (this._saving || 0) + 1, this._allPreviousSaves = this._allPreviousSaves || e.Promise.resolve(), this._allPreviousSaves = this._allPreviousSaves.catch(function(e) {}).then(function() {
            var e = h.id ? "PUT" : "POST",
              t = h._getSaveJSON(),
              n = {};
            ...
            var d = a._makeRequest || u,
              p = d(l, f, h.id, e, t, a, n);
            return p = p.then(function(e) {
              var t = h.parse(e);
              return a.wait && (t = o.extend(i || {}, t)), h._finishSave(t), a.wait && h.set(s, c), h
            }, function(e) {
    ...
    e.exports = function(e) {
      e.Query = function(t) {
        ...
        get: function(e, t) {
          ...
          var i = this.toJSON(),
            o = {};
          return i.keys && (o.keys = i.keys), i.include && (o.include = i.include), i.includeACL && (o.includeACL = i.includeACL), u("classes", this.className, e, "GET", f(o), t).then(function(e) {
      ...
      ! function(t, n) {
        ...
        function E(e) {
          var t = e._subscribers,
            n = e._state;
          if (0 !== t.length) {
            for (var r = void 0, i = void 0, o = e._result, s = 0; s < t.length; s += 3) r = t[s], i = t[s + n], r ? T(n, r, i, o) : i(o);
        ...
        }, L.all = I, L.race = P, L.resolve = l, L.reject = R, L._setScheduler = i, L._setAsap = o, L._asap = V, L.prototype = {
          constructor: L,
          then: c,
          catch: function(e) {
